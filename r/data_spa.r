...
work <- tribble(
    ...
    "Career Counselour", "UNIAT", "January", 2021, "March", 2021, "Guadalajara, MX.", "LANGUAGES USED --- R, RMarkdown",
    "Unity VR Developer", "California State Water Resources Control Board", "January", 2021, "March", 2021, "Guadalajara, MX.", "I developmed data collection, structuring, and reporting systems for various water rights databases",
    ...
    "Unity Developer", "Goetia 2", "October", 2019, "Present", NA, "Remote", "LANGUAGES USED --- HTML, CSS, SASS, JavaScript, R, RMarkdown, SQL, CCL",
